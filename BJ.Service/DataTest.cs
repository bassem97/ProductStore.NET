...
namespace BJ.Service
{
    public class DataTest
    {
        ...
        public static List<Product> Products
        {
            get
            {
                Product acideCitrique = new ChemicalProduct()
                {
                ...
                Product cacaoNaturelle = new ChemicalProduct()
                {
                    DateProd = new DateTime(2000, 12, 12),
                ...
                Product cacaoAlcalinisee = new ChemicalProduct()
                {
                    DateProd = new DateTime(2000, 12, 12),
                ...
                Product dioxyde = new ChemicalProduct()
                {
                    DateProd = new DateTime(2000, 12, 12),
                ...
                Product amidon = new ChemicalProduct()
                {
                    DateProd = new DateTime(2000, 12, 12),
                ...
                Product blackberry = new BiologicalProduct()
                {
                    DateProd = new DateTime(2000, 12, 12),
                    Label = "Blackberry",
                    Description = "",
                ...
                Product apple = new BiologicalProduct()
                {
                    DateProd = new DateTime(2000, 12, 12),
                    Description = "",
                    Category = Categories[0],
        ...
        public static List<Provider> Providers
        {
            get
            {
                Provider sater = new Provider() { Id = 1, Name = "SATER" };
                Provider sudMedical = new Provider() { Id = 2, Name = "SUDMEDICAL" };
                Provider palliserSa = new Provider() { Id = 3, Name = "Palliser SA" };
                Provider prov4 = new Provider() { Id = 4, Name = "PROV4" };
                Provider prov5 = new Provider() { Id = 5, Name = "PROV5", Email = "PROV5@esprit.tn" };
